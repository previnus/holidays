		...
		<div class="wprc-form">
			...
			<div class="left-section">
				...
				<li class="list-item-reason">
					...
					<label for="input-reason-<?php echo $post->ID; ?>">Raisons: <span
				...
				<li class="list-item-name">
					...
					<?php if ($form_options['active_fields']['reporter_name']): ?>
						...
						<label for="input-name-<?php echo $post->ID; ?>">
							...
							<?php if ($required_fields['reporter_name']): ?><span

								class="required-sign">*</span><?php endif; ?>
				...
				<li class="list-item-prenom">
					...
					<?php if ($form_options['active_fields']['reporter_name']): ?>
						...
						<input type="text" id="input-firstname-<?php echo $post->ID; ?>" class="input-name wprc-input"/>
				...
				<li class="list-item-telephone">
					...
					<?php if ($form_options['active_fields']['reporter_name']): ?>
						...
						<input type="text" id="input-telephone-<?php echo $post->ID; ?>" class="input-name wprc-input"/>
				...
				<li class="list-item-email">
					...
					<?php if ($form_options['active_fields']['reporter_email']): ?>
						...
						<label for="input-email-<?php echo $post->ID; ?>">
							...
							<?php if ($required_fields['reporter_email']): ?><span
				...
				<li class="list-item-details">
					...
					<?php if ($form_options['active_fields']['details']): ?>
						...
						<label for="input-details-<?php echo $post->ID; ?>">
							...
							<?php if ($required_fields['details']): ?><span
