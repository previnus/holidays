<?php
if (!class_exists('ASVC_Video_Cover')) {
    class ASVC_Video_Cover{
        function ASVC_Video_Cover() {
            vc_map(array(
      ...
      function asvc_videocover_func($atts, $content=null, $tag) {
          ...
          wp_register_script('vc-extensions-videocover-script', plugins_url('js/init.js', __FILE__), array("jquery", "tooltipster", "formstone-lightbox"));
          wp_enqueue_script('vc-extensions-videocover-script');
